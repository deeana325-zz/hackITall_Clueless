    <header class="page-header gradient">
      <div class="container pt-3">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-5">
            <h2>Built by Clueless Team</h2>

            <p>
              The website for stock investing and market search.
            </p>

            <button type="button" class="btn btn-outline-success btn-lg active" href="stocks.php">
              <a action="nav-link"> Read more </a>
            </button>
          </div>
          <div class="col-md-5">
            <img
